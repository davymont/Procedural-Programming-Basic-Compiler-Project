...
public class Q2 {
	...
	public static void main(String[] args) {
		...
		String file = readFile("src/coursework/Q2example.txt"); /* ERROR: variable name syntax error */
		...
		for (int l = 0; l < lines.length; l++) { // for each line
			...
			while (index < n) { // while index of current character is less than index of last character of
...

					{
						...
						// if '/* */' comment
							...
							while (false == comment.contains("*/")) { // build comment string
								...
								// if comment is opened with /* and not closed with */ skip and continue
				...
				// if char is speechmark "
					...
					// if new line and string has not been completed, break and go onto next line
